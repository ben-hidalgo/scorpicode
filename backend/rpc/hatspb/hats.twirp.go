...
func (c *hatsProtobufClient) FetchOrder(ctx context.Context, in *FetchOrderRequest) (*FetchOrderResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "hats")
	ctx = ctxsetters.WithServiceName(ctx, "Hats")
	ctx = ctxsetters.WithMethodName(ctx, "FetchOrder")
...
func (c *hatsJSONClient) FetchOrder(ctx context.Context, in *FetchOrderRequest) (*FetchOrderResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "hats")
	ctx = ctxsetters.WithServiceName(ctx, "Hats")
	ctx = ctxsetters.WithMethodName(ctx, "FetchOrder")
	out := new(FetchOrderResponse)
...
func (s *hatsServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "/twirp/hats.Hats/FetchHat":
		...
		return
	case "/twirp/hats.Hats/FetchOrder":
		s.serveFetchOrder(ctx, resp, req)
		return
	default:
...
func (s *hatsServer) serveFetchOrder(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveFetchOrderJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveFetchOrderProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *hatsServer) serveFetchOrderJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "FetchOrder")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(FetchOrderRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, malformedRequestError("the json request could not be decoded"))
		return
	...
	// Call service method
	var respContent *FetchOrderResponse
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.Hats.FetchOrder(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *FetchOrderResponse and nil error while calling FetchOrder. nil responses are not supported"))
		return
	}
...
func (s *hatsServer) serveFetchOrderProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "FetchOrder")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
